...
public interface ConfigurationSourceProvider
{
    ...
    * be used to configure a POJO with a given
    * {@link ConfigurationSourceIdentifier}. Providers with lower priority will
    * only be used if a provider with a higher priority cannot be found to
    * support the particular identifier.
    * 
    * The lowest priority provider is the
    * {@link DefaultConfigSourceServiceProvider}.
    */
   public static enum Priority
   {
      /**
       * Should only be used by {@link DefaultConfigSourceServiceProvider}, this
      ...
      /**
       * The highest priority provider, will override any provider that is not
       * also marked as OVERRIDE.
       */
      OVERRIDE
   }

...
<dd>Yes and no. The ConfigurationUtilities class provides a method to send properties update information to a set of Configuration Update Listeners. However, it is up to the Configuration Source Provider implementations to actually call this method if and when the source of the configuration has changed. Please see the tutorial for creating new <a href="#custom-providers">Configuration Source Providers</a> for more information.</dd>
